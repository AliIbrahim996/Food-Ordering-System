...
public class RecyclerViewManageDeliveryAdapter extends RecyclerView.Adapter<RecyclerViewManageDeliveryAdapter.ManageDeliveryViewHolder> {

    private Context mContext;
    private List<DeliveryServices> customer_Meal_bookings;

    public RecyclerViewManageDeliveryAdapter(Context mContext, List<DeliveryServices> customer_Meal_bookings) {
    ...
    public static class ManageDeliveryViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView c_name, order_num, date_in, date_out, status;
