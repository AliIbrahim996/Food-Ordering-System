...
public class SingUpAdminFragment extends Fragment {

    SharedPreferences sharedPreferences;
    private EditText u_fullName, u_email, u_pass, u_confirmPassword, u_age;
    private Button singUp_btn, choose_file;
    private ImageView uploaded_image;
    ByteArrayOutputStream byteArrayOutputStream;
    byte[] byteArray;
    String ConvertImage;
    String email, password, full_name, gender, age, confPass, ip;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.admin_sing_up_fragment, container, false);
        ...
        u_age = mView.findViewById(R.id.u_s_age);
    ...
    private void showPictureDialog() {
        AlertDialog.Builder pictureDialog = new AlertDialog.Builder(mView.getContext());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    FixBitmap = MediaStore.Images.Media.getBitmap(mView.getContext().getContentResolver(), contentURI);
                    Toast.makeText(mView.getContext(), "Image Saved!", Toast.LENGTH_SHORT).show();
    ...
    class UploadTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("http://" + sharedPreferences.getString("SERVER_IP", ip) +
                        "/HI-Food/API/Controller/AdminController/register.php");
        ...
        protected void onPostExecute(String response) {
            if (response == null) {
                Toast.makeText(mView.getContext(), "THERE WAS AN ERROR Response null", Toast.LENGTH_LONG).show();
                return;
            }
            if (responseCode != 201) {
                Toast.makeText(mView.getContext(), "THERE WAS AN ERROR response code is: " + responseCode, Toast.LENGTH_LONG).show();
                return;
            }
            String message = "";
            int flag = -2;
            ...
            try {
                ...
                Toast.makeText(mView.getContext(), "There was an error" + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
    }
}
