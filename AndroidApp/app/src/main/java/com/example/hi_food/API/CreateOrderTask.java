...
public class CreateOrderTask extends AsyncTask<Void, Void, String> {
    ...
    public CreateOrderTask(Context mContext, SharedPreferences sharedPreferences,
                           String ip, String rest_email, int meal_id,
                           String c_email, int quantity) {
        ...
        try {
            if (quantity != 0) {
                URL url = new URL("http://" + sharedPreferences.getString("SERVER_IP", ip) +
                        "/HI-Food/API/Controller/ReservationController/createMealReservation.php");
    ...
    protected void onPostExecute(String response) {
        try {
            ...
            if (flag == 1) {
                System.out.println("Message " + message + "for meal " + meal_id);
            } else {
