...
public class UpdateRestaurantRView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_restaurant_rview);
        ...
        r = (Restaurant) intent.getExtras().get("restaurant");
        ...
        if (r.getStatus().equals("1")) {
            addRestStatus_Value.setChecked(true);
        }
        ...
        addRestButton.setOnClickListener(v -> {
            ...
            if (
                    TextUtils.isEmpty(rest_name) &&
                            TextUtils.isEmpty(rest_phone) &&
                            TextUtils.isEmpty(rest_loc) &&
                            TextUtils.isEmpty(rest_openAt) &&
                            TextUtils.isEmpty(rest_closeAt) &&
                            TextUtils.isEmpty(ConvertImage)) {
    ...
    private void getImageData() {
        ...
        Bitmap bitmap = ((BitmapDrawable) uploaded_image.getDrawable()).getBitmap();
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("http://" + sharedPreferences.getString("SERVER_IP", ip) +
                        "/HI-Food/API/Controller/AdminController/adminUpdateRest.php");
                ...
                uData.put("id", r.getId());
                /**
                 *  "id":"13",
                 *             "restaurant_name":"Hi-food",
                 *             "restaurant_address":"KSA",
                 *             "restaurant_phone_no":"0990909",
                 *             "is_accepted":"0",
                 *             "restaurent_img":"Hi-food.jpg",
                 *             "open_at":"12 am",
                 *             "close_at":"12 am"
                 * */
