...
public class RecyclerViewBrowseRating extends RecyclerView.Adapter<RecyclerViewBrowseRating.ManageRatingViewHolder> {

    private Context mContext;
    private List<Rate> ratings;

    public RecyclerViewBrowseRating(Context mContext, List<Rate> meals) {
    ...
    public ManageRatingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mView = inflater.inflate(R.layout.admin_rating_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ManageRatingViewHolder holder, int position) {
        ...
        holder.ratingRsetName.setText(rate.getResturant_name());
        holder.showFeedBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
                builder.setTitle("FeedBack");
                String msg = "FeedBack: " + rate.getFeedBack();
    ...
    public static class ManageRatingViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView ratingValue, customer_name, ratingRsetName;
        Button showFeedBack;
        ...
        public ManageRatingViewHolder(@NonNull View itemView) {
            ...
            ratingRsetName = itemView.findViewById(R.id.ratingRsetName);
        }
    }
}
